...
(function () {
  ...
  if (SeamlessPosting.Floating !== undefined) {
    return;
  }
  ...
  Floating.prototype = Object.create(SeamlessPosting.NodeResourceItem.prototype);
  Floating.super = SeamlessPosting.NodeResourceItem.prototype;
  ...
  SeamlessPosting.FloatingResourceItem = Floating;
